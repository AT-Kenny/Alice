...
{{"hi alice","hello","sup","hai"},{function(ply) local unique=ply:UniqueID() if !Alice.players[unique].greeted then Alice.Reply(table.Random({"hi!","Hi!","hello"})) Alice.players[unique].greeted=true end end}},
